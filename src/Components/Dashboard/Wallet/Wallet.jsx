...
const Wallet = () => {
  ...
  return (
    <div>
      <div className="bg-[#212121] min-h-auto px-4 lg:px-8 py-4 mb-[3em] rounded-md ">
        ...
        <div className="flex flex-col mb-[3em] lg:flex-row w-full lg:flex-wrap ">
          <div className="bg-[#71717a] w-full lg:w-1/4 lg:mr-2 flex items-center mb-4 rounded-md px-4 py-2">
            <RiShoppingBag3Line className="text-2xl mr-4 text-[#23bab1] " />
            <div className="flex flex-col">
              <span className="text-sm font-medium ">Total Investments</span>
              <span className="text-base font-normal">$100,000.00</span>
            </div>
          </div>
          <div className="bg-[#71717a] w-full lg:w-1/4 lg:mr-2 justify-between flex mb-4 rounded-md px-4 py-2">
          ...
          <div className="bg-[#71717a] w-full lg:w-1/4 lg:mr-2  flex justify-between mb-4 rounded-md px-4 py-2">
            <div className="flex items-center text-[1em] font-normal">
              <AiOutlineCreditCard className="text-2xl mr-4 text-[#23bab1] " />
              <div className="flex flex-col">
                <span className="text-sm font-medium ">Investment Profits</span>
                <span className="text-base font-normal">$20,000.00</span>
              </div>
            </div>
            <div className="flex text-xs text-Yellow-500">100%</div>
          </div>
          <div className="bg-[#71717a] w-full lg:w-1/5 lg:mr-2  flex justify-between mb-4 rounded-md px-4 py-2">
            <div className="flex items-center text-[1em] font-normal">
              <AiOutlineCreditCard className="text-2xl mr-4 text-[#23bab1] " />
              <div className="flex flex-col">
                <span className="text-sm font-medium ">Unresolved Balance</span>
                <span className="text-base font-normal">$0.00</span>
              </div>
            </div>
            <div className="flex text-xs text-Teal-500">100%</div>
          </div>
          <div className="bg-[#71717a] w-full lg:w-1/4  flex justify-between mb-4 rounded-md px-4 py-2">
            <div className="flex items-center text-[1em] font-normal">
              <AiOutlineCreditCard className="text-2xl mr-4 text-[#23bab1] " />
              <div className="flex flex-col">
                <span className="text-sm font-medium ">Bonus</span>
                <span className="text-base font-normal">$740,000.00</span>
              </div>
            </div>
            <div className="flex text-xs text-Yellow-500">100%</div>
          </div>
