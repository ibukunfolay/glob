  ...
  return (
    <div className="min-h-screen relative flex flex-col py-10 bg-gradient-to-b from-black to-[#0B0D26]">
      <div className="flex w-full justify-between items-center mx-auto ">
        ...
        <div className="box flex flex-col md:w-1/3 sm:w-3/5 w-full mx-4 justify-center px-10  py-8 mx-auto backdrop-blur-2xl bg-black rounded-xl">
          ...
          <div className=" flex flex-col border-b-2 border-Pink-300 mb-[1.5em]">
            <label htmlFor="fullname" className="text-white font-semibold mb-1">
              Fullname:
            </label>
            <input
              type="text"
